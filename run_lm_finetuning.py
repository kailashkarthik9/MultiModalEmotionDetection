# # # Forked from HuggingFace github repository
...
def main():
    ...
    parser.add_argument("--model_name_or_path", default="bert-base-bert_cased", type=str,
    ...
    parser.add_argument("--do_lower_case", action='store_true',
                        help="Set this flag if you are using an bert_uncased model.")
